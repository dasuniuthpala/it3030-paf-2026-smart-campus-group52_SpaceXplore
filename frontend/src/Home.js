          ...
          <div className="flex flex-col gap-4">
            {capabilities.map((item) => (
              <button
                ...
                className={`group relative flex flex-row items-center md:items-start gap-4 rounded-2xl p-3 md:p-4 text-left transition-all duration-500 overflow-hidden ${activeTab === item.id
              ...
              >
                ...
                <div className={`mt-1 flex h-12 w-12 shrink-0 items-center justify-center rounded-xl transition-all duration-500 ${activeTab === item.id
                ...
                <div className="hidden md:block">
                  <h4 className={`text-base font-bold transition-colors ${activeTab === item.id ? 'text-indigo-900 dark:text-indigo-300' : 'text-slate-600 dark:text-slate-300 group-hover:text-indigo-600 dark:group-hover:text-indigo-400'
                    }`}>
                    {item.title}
                  </h4>
