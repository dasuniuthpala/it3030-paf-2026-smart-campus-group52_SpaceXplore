    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-200 transition-colors duration-500">
      ...
      <div className="mx-auto flex max-w-md items-center justify-center px-4 py-12 sm:px-6 lg:px-8 mt-10">
        <div className="w-full rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-8 shadow-[0_5px_20px_rgba(0,0,0,0.05)] dark:shadow-[0_5px_20px_rgba(0,0,0,0.3)] transition-colors">
          <h1 className="text-3xl font-black text-center mb-2 text-slate-800 dark:text-white">Create Account</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400 text-center mb-6">Join SpaceXplore Platform to manage campus spaces</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label htmlFor="firstName" className="block text-sm font-semibold mb-2 text-slate-700 dark:text-slate-300">
                  First Name
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="lastName" className="block text-sm font-semibold mb-2 text-slate-700 dark:text-slate-300">
                  Last Name
                </label>
                <input
                  type="text"
            ...
            <div>
              <label htmlFor="role" className="block text-sm font-semibold mb-2 text-slate-700 dark:text-slate-300">
                Role
              </label>
              <select
                id="role"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-semibold mb-2 text-slate-700 dark:text-slate-300">
                Confirm Password
              </label>
              <input
                type="password"
